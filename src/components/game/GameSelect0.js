                ...
                style={{backgroundColor:'grey'}}>
                    <Container>
                        ...
                        >
                            ...
                            <Grid style={{ backgroundColor: 'white', height: '100vh', fontSize:20}}>
                    <GridColumn>
                <Container >
                <Header textAlign='center' style={{  backgroundColor: 'white', color:'white'}} size='huge'>Top 10 scores</Header>
                <Container >
                    <Table padded singleLine size="large" style={{  backgroundColor: 'black', color:'white'}}>
                        <Table.Header style={{ backgroundColor: 'white', color:''}}>
                        <Table.Row style={{ backgroundColor: 'white', color:'white'}}>
